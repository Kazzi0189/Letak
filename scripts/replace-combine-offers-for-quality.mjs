...
const combineOffersScript = `import { copyFile, mkdir, readFile, writeFile } from "node:fs/promises";
...
await writeFile("scripts/combine-offers.mjs", combineOffersScript, "utf8");
console.log("Replaced scripts/combine-offers.mjs for offer quality filter.");
